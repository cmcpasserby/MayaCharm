...
class SettingsProvider : PersistentStateComponent<SettingsProvider.State> {
    ...
    companion object {
        fun getInstance(project: Project):SettingsProvider {
            return ServiceManager.getService(project, SettingsProvider::class.java)
        }
    }
}
